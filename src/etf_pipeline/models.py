...
class Derivative(Base):
    ...
    underlying_name: Mapped[str] = mapped_column(String(500), nullable=False, default="", server_default="")
    ...
    counterparty: Mapped[str] = mapped_column(String(500), nullable=False, default="", server_default="")
    counterparty_lei: Mapped[Optional[str]] = mapped_column(String(20))
    delta: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 6))
    expiration_date: Mapped[date] = mapped_column(Date, nullable=False, server_default="9999-12-31")
...
class FundSnapshot(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    cik: Mapped[str] = mapped_column(String(10), nullable=False)
    series_id: Mapped[str] = mapped_column(String(20), nullable=False, default="", server_default="")
    report_date: Mapped[date] = mapped_column(Date, nullable=False)
    filing_date: Mapped[date] = mapped_column(Date, nullable=False)
...
class NPORTMonthlyReturn(Base):
    ...
    month_1_return: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 6))
    month_2_return: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 6))
    month_3_return: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 6))
