				...
				<div class="content">
					...
					<table class="filerInformation">
						<tr>
							...
							<td>
								<xsl:choose>
									<xsl:when test="m1:isConfidential = 'true'">
										<img
											src="Images/box-checked.jpg"
											alt="Confidential is checked" />
									</xsl:when>
									<xsl:otherwise>
										<img
											src="Images/box-unchecked.jpg"
											alt="Confidential is not checked" />
									</xsl:otherwise>
								</xsl:choose>
							</td>
						</tr>
						...
						<xsl:if test="string($submissionType) = 'NPORT-P/A'">
						<tr>
					           <td class="label">Accession Number</td>
						        <td>
							          <div class="fakeBox2">
								         <xsl:value-of select="string(m1:accessionNumber)"/>
										<span>
											 <xsl:text>&#160;</xsl:text>
										</span>
							          </div>
