...
<p>For portfolio investments of open-end management investment companies, provide the percentage of the 
Fund's Highly Liquid Investments that it has segregated to cover or pledged to 
satisfy margin requirements in connection with derivatives transactions that are classified among  the 
